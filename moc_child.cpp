...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_child_t, stringdata) + ofs \
...
void child::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        child *_t = static_cast<child *>(_o);
        switch (_id) {
        case 0: _t->enableOkButton((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject child::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_child.data,
      qt_meta_data_child,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_child.stringdata))
